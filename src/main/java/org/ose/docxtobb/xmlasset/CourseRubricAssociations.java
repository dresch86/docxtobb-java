...
public class CourseRubricAssociations {
    private final VDocument vdCrcRubricAssocsXML;

    public CourseRubricAssociations() {
        vdCrcRubricAssocsXML = VDocument.of("COURSERUBRICASSOCIATIONS");
    }

    public void writeBBXML(FileOutputStream os) {
        vdCrcRubricAssocsXML.print(os);
    }
}